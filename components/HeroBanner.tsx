    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-max gap-10">
                {/* Left text content */}
                <div className="lg:max-w-[50%] text-center lg:text-left z-10">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
                        Optimize Your<span className="block"> Sales, Maximize</span>
                        <span className="block">Your Profits</span>
                    </h1>
                    <p className="text-neutral-200 text-sm sm:text-base mt-4">
                ...
                {/* Right person + cards */}
                <div className="lg:max-w-[50%] relative w-full flex justify-center items-center">
                    <div
                    ...
                    >
                        <Image
                            ...
                            height={1000}
                            priority
                            className="object-contain max-w-[660px] sm:max-w-[360px] lg:max-w-[1000px] rounded-full"
                        />
                    </div>

                    {/* Target Attainment Card */}
                    <div className="absolute left-[70%] top-[20%] sm:right-0 bg-white shadow-lg rounded-xl px-3 py-2 sm:px-4 sm:py-3 w-[130px] sm:w-[170px] text-black text-xs sm:text-sm flex flex-col items-start">
                    ...
                    {/* Win Rate Card */}
                    <div className="absolute top-[40%] left-[-20px] sm:left-[-20px] bg-white shadow-md rounded-xl px-3 py-2 sm:px-4 sm:py-3 w-[100px] sm:w-[170px] text-black text-xs sm:text-sm">
                    ...
                    <div className="absolute bottom-0 sm:right-0 bg-white shadow-md rounded-xl px-3 py-2 sm:px-4 sm:py-3 w-[140px] sm:w-[180px] text-black text-xs sm:text-sm">
