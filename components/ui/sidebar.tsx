  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linea r",
      ...
      <div
        ...
        className={cn(
          " sticky inset-y-0 z-10 hidden h-svh w-[248px] transition-[left,right,width] duration-200 ease-linear md:flex bg-[rgba(255, 255, 255, 0.06)] py-4 pr-4 ",
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",

          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+4px)]"
      ...
      >
        <div
          ...
          className=" effect cursor-default h-full px-3 pt-2 pb-1 w-full group-data-[collapsible=icon]:p-2 rounded-2xl relative"
        >
...
function SidebarMenuSub({
  ...
  return (
    <ul
      ...
      className={cn(
        " pl-3 flex w-full flex-col py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
    >
      {React.Children.map(children, (child) => {
        if (!React.isValidElement<SidebarMenuSubItemProps>(child)) return child;

        return React.cloneElement(child, { showLine: true });
      })}
    </ul>
  );
}
        ...
        >
          ...
          <div
            style={{
              ...
              background: active ? "#FFD89D" : "#FFF1DD",
            }}
          />
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring flex h-7 w-full -translate-x-px items-center gap-2 overflow-hidden rounded-lg outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate ",
