...
function DropdownMenuTriggerWrapper({
  ...
  return (
    <div className="relative w-full max-w-2xl">
      ...
      <div
        className={cn(
          "relative flex items-center gap-2.5 w-full  backdrop-blur-xl",
          className
        )}
        style={{
          boxShadow:
      ...
      >
        ...
        <DropdownMenuTrigger className={`focus:outline-none px-5 py-2.5 `}>
          {children}
        </DropdownMenuTrigger>
      </div>
    </div>
...
export {
  DropdownMenu as GLDropdownMenu,
  DropdownMenuPortal as GLDropdownMenuPortal,
  DropdownMenuTriggerWrapper as GLDropdownMenuTrigger,
  DropdownMenuContent as GLDropdownMenuContent,
  DropdownMenuGroup as GLDropdownMenuGroup,
  DropdownMenuLabel as GLDropdownMenuLabel,
  DropdownMenuItem as GLDropdownMenuItem,
  DropdownMenuCheckboxItem as GLDropdownMenuCheckboxItem,
  DropdownMenuRadioGroup as GLDropdownMenuRadioGroup,
  DropdownMenuRadioItem as GLDropdownMenuRadioItem,
  DropdownMenuSeparator as GLDropdownMenuSeparator,
  DropdownMenuShortcut as GLDropdownMenuShortcut,
  DropdownMenuSub as GLDropdownMenuSub,
  DropdownMenuSubTrigger as GLDropdownMenuSubTrigger,
  DropdownMenuSubContent as GLDropdownMenuSubContent,
};
