...
export function Input({
  ...
  return (
    <div className="relative h-11 effect flex items-center gap-3 px-4   bg-white/10 backdrop-blur-3xl rounded-[12px] focus-within:border-white/30 focus-within:shadow-md transition-[box-shadow,border-color]">
