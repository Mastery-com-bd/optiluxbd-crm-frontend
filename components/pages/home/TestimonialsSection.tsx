...
import LightForSection3 from "@/components/svgIcon/LightForSection3-1";
...
const groupTestimonials = (data: any[]) => {
    ...
    while (i < data.length) {
        ...
        if (data[i]) {
            console.log("data of i->> ", i, "-->>>", data[i]);
...
const testimonials = [
    { name: 'Andy Wirth', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Working with Thevent was a game-changer for our annual conference. Their attention to detail, professionalism, and creativity exceeded our expectations.", date: '01:06 PM · Apr 11, 2024' },
    { name: 'Elsa Verina', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Working with Thevent was a game-changer for our annual conference.", date: '01:06 PM · May 11, 2024' },
    { name: 'Kumto Warming', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Working with Thevent was a game-changer for our annual conference.", date: '01:06 PM · Jun 17, 2024' },
    { name: 'Diyas Kardinal', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Working with Thevent was a game-changer for our annual conference. Their attention to detail and creativity exceeded our expectations.", date: '01:06 PM · Jun 13, 2024' },
    { name: 'Akash Hossain', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "The interface is amazing and the support is even better!", date: '02:30 PM · July 20, 2024' },
    { name: 'Fatima Rahman', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Easy to use, effective, and stunningly designed.", date: '10:00 AM · Aug 05, 2024' },
    { name: 'Jamal Uddin', image: 'https://i.ibb.co.com/KxJvdpz3/t-shirt.jpg', quote: "Best CRM platform we have used so far. Highly recommended.", date: '05:45 PM · Sept 12, 2024' },
];
