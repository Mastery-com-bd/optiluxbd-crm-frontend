                                            ...
                                            >
                                                ...
                                                <TableCell className="text-center">
                                                    <div className="flex flex-col  space-y-0.5 ">
                                                        {/* Status Badge */}
                                                        <span className="text-xs px-2 py-0.5 bgGlass  rounded-full w-fit text-red-800">
                                                            Low
                                                        </span>

                                                        {/* Stock Bar */}
                                                        <div className="w-full  h-2 rounded-full bg-white/20 overflow-hidden mt-1">
                                                            <div
                                                                className="h-full bg-orange-600"
                                                                style={{
                                                                    width: `${Math.min((product.stock / 10) * 100, 100)}%`, // Assuming 10 is "danger zone"
                                                                }}
                                                            ></div>
                                                        </div>
