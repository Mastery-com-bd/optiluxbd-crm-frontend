...
const ComboCreation = () => {
  ...
  return (
    <div className="space-y-4">
      {/* header section */}
      <div>
        <h1 className="text-3xl font-semibold">Create Combo</h1>
        <p className="text-[#A1A1A1] leading-5">
          Create new combo individually with multiple products
        </p>
      </div>
          ...
          <div className="">
            ...
            <div className="flex flex-col lg:flex-row gap-6 w-full ">
              ...
              <div className="flex-1 min-w-0  ">
                <div className="bgGlass rounded-xl p-6 h-full space-y-6">
                  <h2 className="text-xl font-semibold text-white">
                    Combo details
                  </h2>
                  <div>
                    <Label htmlFor="productName">Combo Name *</Label>
                    <Input
                      id="productName"
              ...
              <div className="flex-1 min-w-0">
                <div className="bgGlass rounded-xl p-6 h-full flex flex-col border border-white/20 shadow-lg">
                  ...
                  >
                    <Images className="w-10 h-10 mx-auto mb-4 text-white opacity-80" />
                    <p className="text-base font-semibold text-white mb-2">
                      Upload your Combo image.
                    </p>
            ...
            <div className="grid grid-cols-3 w-full gap-6 my-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <Card className="p-6 space-y-4 bgGlass border border-red-600">
