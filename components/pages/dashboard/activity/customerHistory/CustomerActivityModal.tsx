...
import { useGetCustomerHistoryQuery } from "@/redux/features/audit/admin/adminAuditApi";
...
import UserActivityExpandItem from "../userActivity/UserActivityExpandItem";
import PaginationControls from "@/components/ui/paginationComponent";

const CustomerActivityModal = ({ id, name }: { id: string; name: string }) => {
  ...
  const { data, isLoading } = useGetCustomerHistoryQuery(
    { id, filters },
