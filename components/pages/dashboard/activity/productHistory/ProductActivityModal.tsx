...
import { useGetProductHistoryQuery } from "@/redux/features/audit/admin/adminAuditApi";
...
const ProductActivityModal = ({ id, name }: { id: string; name: string }) => {
  ...
  const { data, isLoading } = useGetProductHistoryQuery(
    { id, filters },
