...
const UserActivityExpandItem = ({ log }: { log: AuditLog }) => {
  const [expanded, setExpanded] = useState(false);
  return (
    <div
      onClick={() => setExpanded(!expanded)}
      className="rounded-lg text-sm cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition p-2"
    >
...
export default UserActivityExpandItem;
