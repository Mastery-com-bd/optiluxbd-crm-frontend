...
export const crmRoutes: NavRoute[] = [
  ...
  },
  {
    ...
    icon: Package,
    children: [
      { title: "All Products", path: "/dashboard/admin/products/all-products", icon: ListOrdered },
      { title: "Add Product", path: "/dashboard/admin/products/add-product", icon: PlusSquare },
      { title: "Draft Products", path: "/dashboard/admin/products/drafts", icon: FileMinus },
      { title: "Deleted Products", path: "/dashboard/admin/products/deleted", icon: Trash2 },
      { title: "Reviews", path: "/dashboard/admin/products/reviews", icon: Star },
      { title: "Inventory", path: "/dashboard/admin/products/inventory", icon: Warehouse },
      { title: "Bulk Upload", path: "/dashboard/admin/products/bulk-upload", icon: Upload },
    ],
  },
  {
    title: "Categories",
  ...
  },
  {
    ...
    icon: ShoppingCart,
    children: [
      { title: "All Orders", path: "/dashboard/admin/orders", icon: ClipboardList },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Roles & Permissions", path: "/dashboard/hr&staff/roles", icon: Shield },
